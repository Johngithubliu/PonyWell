...
TASK_ITEM(proc_send2srv,       send2srv_id,   5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_tcp_network,       tcp_network_id,   5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
